...
namespace Lucy.Controllers
{
    ...
    public class DietasController : Controller
    {
        ...
        public ActionResult Edit(long? id)
        {
            ...
            if (oldContDieta == null || oldContDieta.Dieta == null || oldContDieta.UsuarioAutor.UsuarioId != idUsu)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult comenzarDieta(long idDieta)
        {
            ...
            return RedirectToAction("Details", new { id = idDieta });
        }
        ...
        public ActionResult Delete(long? id)
        {
            ...
            if (contenido == null || contenido.Dieta == null || contenido.UsuarioAutor.UsuarioId != idUsu)
            {
                return HttpNotFound();
            }
